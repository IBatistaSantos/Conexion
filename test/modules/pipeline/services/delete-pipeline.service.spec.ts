...
import { DeletePipelineService } from '../../../../src/modules/pipeline/services/delete-pipeline.service';
...
describe('DeletePipelineService', () => {
  let service: DeletePipelineService;
  ...
  beforeEach(async () => {
    ...
    service = module.get<DeletePipelineService>(DeletePipelineService);
  });
  ...
  it('should call delete with correct parameters', async () => {
    ...
    expect(pipelineRepository.delete).toBeCalledWith({
      pipelineId: 'any_pipelineId',
    });

    expect(pipelineRepository.delete).toHaveBeenCalledTimes(1);
  });
});
